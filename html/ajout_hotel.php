...
try {
    ...
    $stmt = $dbpdo->prepare("SELECT id_hotel, nom_hotel, description_hotel, prix_hotel, photo_hotel FROM hotel");
    $stmt->execute();
    $annonces = $stmt->fetchAll(PDO::FETCH_ASSOC);
    $requette=$dbpdo->prepare('SELECT COUNT(*) as nb_user FROM hotel');
    $requette->execute();
...
<head>
    ...
    <link rel="stylesheet" href="../css/ajout_hotel.css">
...
<body>
            ...
            <label for="check" class="checkbtn">
             ...
             <label class="logo"> 𝕄ℕ𝔹 𝕋𝕣𝕒𝕧𝕖𝕝 </label>
               ...
               <li><a  href="../index.php">Acceuil</a></li>
                ...
                <li><a class="active" href="ajout_hotel.php">Hotel</a></li>
    ...
    <?php
            ...
            foreach ($annonces as $annonce) {
                ...
                <img src="<?php echo htmlspecialchars('admin/img/' . $annonce['photo_hotel']); ?>" alt="Photo de l'hotel">
                    <h3><?php echo htmlspecialchars($annonce['nom_hotel']); ?></h3>
                    <p><?php echo htmlspecialchars($annonce['description_hotel']); ?></p>
                    <a href="detaille_hotel.php?id=<?php echo htmlspecialchars($annonce['id_hotel']); ?> " class="cta-button">Réservez maintenant</a>
                </div>
